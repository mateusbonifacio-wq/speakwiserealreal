# Setup Projects Table - Guia Rápido

## ⚡ Execução Rápida no Supabase Dashboard
...
5. **Verifique:**
   ...
   - Vá em **Table Editor** e verifique se a tabela `projects` aparece

## ✅ Após executar

Recarregue a página do app e o erro deve desaparecer. Você poderá criar projetos normalmente!
